...
protected:
	...
	DECLARE_MESSAGE_MAP()
public:
	afx_msg void OnBnClickedSelSaveRect();
	int m_nFPS;
	BOOL m_bSaveView;
	int m_nNotViewOpt;
	afx_msg void OnBnClickedNotViewOpt3();
	afx_msg void OnBnClickedNotViewOpt();
	afx_msg void OnBnClickedNotViewOpt2();
	afx_msg void OnBnClickedSaveView();
